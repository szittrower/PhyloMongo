...
class materializedPaths(MongoTree.MongoTree):
	...
	def checkIfPresent(self):
		if self.skel.count() == 0:
			return False
		if 'path' not in self.skel.find_one():
			return False
		return True
...
if __name__ == "__main__":
	a = materializedPaths("localhost", "arbor", "SmallTree.PhyloTree.SmallTree2Skel", "SmallTree.PhyloTree.SmallTree2")
	a.generateFromChildTree()
	#print "loc test"
	...
	#it = a.getDescendantsCriteria("511a95d9df790d08f000018c", "loc")
	#for item in it:
